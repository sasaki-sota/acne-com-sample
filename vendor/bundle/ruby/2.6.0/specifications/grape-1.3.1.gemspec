...
Gem::Specification.new do |s|
  ...
  s.metadata = { "bug_tracker_uri" => "https://github.com/ruby-grape/grape/issues", "changelog_uri" => "https://github.com/ruby-grape/grape/blob/v1.3.1/CHANGELOG.md", "documentation_uri" => "https://www.rubydoc.info/gems/grape/1.3.1", "source_code_uri" => "https://github.com/ruby-grape/grape/tree/v1.3.1" } if s.respond_to? :metadata=
